---
name: code-solver
description: 快速解答算法题并审查代码，先归档中文题解，再生成 Java、Python、C、C++ 或 TypeScript 可运行单文件；detail 额外生成可运行测试代码，review 支持用户上传或指定代码规范。用于力扣/LeetCode、算法题、刷题、题解、测试用例、代码检查、报错定位和复盘。
---
